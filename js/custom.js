(function (factory) {
    ...
    const btns = document.querySelectorAll('.button-js');
    ...
    closeMenuBtn.addEventListener("click", burgerMenuClose);
    ...
    uslugi && uslugi.addEventListener('click', e => {
